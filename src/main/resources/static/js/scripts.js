function addElement() {
    ...
    newElement.innerHTML = `
        <td><input placeholder="Channel/spot" required type="text" min="1" class="form-control" name="elements[${elementCount}].channel"/></td>
        <td><input placeholder="Resource name" required type="text" class="form-control" name="elements[${elementCount}].name" /></td>
